...
export const translations = {
  en: {
    appName: "Simex World Cup Prediction Game",
    common: {
    ...
    retired: {
      gameName: "World Cup Prediction Game",
      headerSubtitle: "The game returns for World Cup 2030.",
      navArchive: "2026 Final Results",
      eyebrow: "Simex",
      completed: "World Cup 2026 — Completed",
      championCountry: "Spain",
      championTitle: "World Champions 2026",
      heroNote: "A tournament to remember. A prediction game to celebrate.",
      returnEyebrow: "The next chapter",
      returnTitle: "The game will return.",
      nextTournament: "World Cup 2030",
      seeYou: "See you in 4 years.",
      returnBody: "The Simex World Cup Prediction Game will return for the FIFA World Cup 2030.",
      archiveEyebrow: "World Cup 2026 archive",
      archiveTitle: "The final table",
      archiveBody: "Relive the final leaderboard and results from the completed 2026 Simex prediction game.",
      archiveButton: "View 2026 Final Results",
      archiveNote: "The archive is read-only. Predictions and historical results cannot be changed.",
      footer: "Simex World Cup Prediction Game · The game will return in 2030.",
    },
    home: {
    ...
    leaderboard: {
      ...
      subtitle: "Explore the final ranking, total points, exact scores, and correct outcomes from the completed 2026 game.",
      rank: "Rank",
      name: "Name",
      department: "Dept.",
      points: "Points",
      ...
      officialRanking: "Final ranking",
      sortHelper: "Default order shows the final official ranking. Click column headers to sort the table view.",
      currentLeader: "2026 winner",
      currentLeaders: "2026 winners",
      firstPlace: "1st place",
      secondPlace: "2nd place",
      thirdPlace: "3rd place",
      prizePlaces: "Final podium",
      playersTied: "players tied",
      more: "more",
      totalPlayers: "Total players",
      totalPredictions: "Total predictions",
      bestDepartment: "Best department",
      empty: "No archived predictions are available.",
      none: "None",
      currentRanking: "Final 2026 ranking",
    ...
    matchTalk: {
      ...
      commentCountSingular: "1 comment",
      commentCountPlural: (count: number) => `${count} comments`,
      nameRequired: "Please enter your name.",
      commentRequired: "Please enter a comment.",
      commentTooLong: "Comments can be up to 300 characters.",
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            "Data from the 2026 game may be retained as a read-only historical archive and for internal documentation, subject to applicable privacy and retention requirements.",
          ],
        },
        {
  ...
  de: {
    ...
    retired: {
      gameName: "World Cup Tippspiel",
      headerSubtitle: "Das Spiel kehrt zur WM 2030 zurück.",
      navArchive: "Finalresultate 2026",
      eyebrow: "Simex",
      completed: "WM 2026 — Abgeschlossen",
      championCountry: "Spanien",
      championTitle: "Weltmeister 2026",
      heroNote: "Ein Turnier, das in Erinnerung bleibt. Ein Tippspiel zum Feiern.",
      returnEyebrow: "Das nächste Kapitel",
      returnTitle: "Das Spiel kehrt zurück.",
      nextTournament: "WM 2030",
      seeYou: "Bis in 4 Jahren.",
      returnBody: "Das Simex WM-Tippspiel kehrt zur FIFA Fussball-Weltmeisterschaft 2030 zurück.",
      archiveEyebrow: "WM-Archiv 2026",
      archiveTitle: "Die Endrangliste",
      archiveBody: "Entdecke die Endrangliste und Resultate des abgeschlossenen Simex Tippspiels 2026.",
      archiveButton: "Finalresultate 2026 ansehen",
      archiveNote: "Das Archiv ist schreibgeschützt. Tipps und historische Resultate können nicht geändert werden.",
      footer: "Simex WM-Tippspiel · Das Spiel kehrt 2030 zurück.",
    },
    home: {
    ...
    leaderboard: {
      title: "Finalresultate 2026",
      subtitle: "Entdecke die endgültige Rangliste, Gesamtpunkte, exakten Ergebnisse und richtigen Tendenzen des abgeschlossenen Tippspiels 2026.",
      rank: "Rang",
      name: "Name",
      department: "Abt.",
      points: "Punkte",
      ...
      officialRanking: "Endrangliste",
      sortHelper: "Die Standardansicht zeigt die offizielle Endrangliste. Klicke auf Spaltenüberschriften, um die Tabellenansicht zu sortieren.",
      currentLeader: "Sieger 2026",
      currentLeaders: "Sieger 2026",
      firstPlace: "1. Platz",
      secondPlace: "2. Platz",
      thirdPlace: "3. Platz",
      prizePlaces: "Finales Podest",
      ...
      empty: "Keine archivierten Tipps verfügbar.",
      none: "Keine",
      currentRanking: "Endrangliste 2026",
      ...
      predictionSections: {
        ...
        correctOutcomes: "Richtige Tendenzen",
        noPoints: "Keine Punkte",
        pending: "Ausstehend",
      },
    ...
    results: {
      ...
      expandDay: "Tag öffnen",
      collapseDay: "Tag schliessen",
      finishedResults: "Beendete Spiele",
      finishedMatches: "beendete Spiele",
      finishedDates: "beendete Tage",
      statusLabels: {
    ...
    matchTalk: {
      ...
      post: "Posten",
      reply: "Antworten",
      showReplies: (count: number) => `${count} ${count === 1 ? "Antwort" : "Antworten"} anzeigen`,
      hideReplies: "Antworten ausblenden",
      noComments: "Noch keine Kommentare.",
      commentCountSingular: "1 Kommentar",
      commentCountPlural: (count: number) => `${count} Kommentare`,
      nameRequired: "Bitte gib deinen Namen ein.",
      commentRequired: "Bitte gib einen Kommentar ein.",
      commentTooLong: "Kommentare dürfen maximal 300 Zeichen lang sein.",
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            "Daten aus dem Tippspiel 2026 können als schreibgeschütztes historisches Archiv und für interne Dokumentationszwecke aufbewahrt werden, unter Einhaltung der geltenden Datenschutz- und Aufbewahrungsanforderungen.",
          ],
        },
        {
